...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-8 offset-md-2">
            <h2>Introduction</h2>
            <p>Welcome to [Your Company Name]. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website [your website URL] or use our services. Please read this policy carefully.</p>
            ...
            <ul>
                ...
                <li><strong>Derivative Data:</strong> Information our servers automatically collect when you access the site, such as your IP address, your browser type, your operating system, your access times, and the pages you have accessed directly before and after accessing the site.</li>
            ...
            <ul>
                ...
                <li><strong>Third-Party Service Providers:</strong> We may share your information with third-party service providers that perform services for us or on our behalf, such as payment processing, data analysis, email delivery, hosting services, customer service, and marketing assistance.</li>
            </ul>
